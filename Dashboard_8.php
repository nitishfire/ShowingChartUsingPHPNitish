...
$query = $conn->query("SELECT sector, intensity FROM data");
$sector = [];
...
<script>
    var labels = <?php echo json_encode($uniquee); ?>;
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: labels,
            datasets: [{
                label: 'Distribution of Sector Over Intensity',
                data: data,
                backgroundColor: [
                    'rgb(255, 99, 132)',
                    'rgb(54, 162, 235)',
